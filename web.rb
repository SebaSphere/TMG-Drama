...
<html>
<head>
<title>The Modder's Guild Drama Generator</title>
<meta charset="utf-8">
<meta name="description" content="<%= drama %>">
<meta name="viewport" content="width=device-width,initial-scale=1">
<meta name="theme-color" content="#111111">

<meta property="og:title" content="The Modder's Guild Drama Generator">
<meta property="og:type" content="website">
<% if permalink %>
<meta property="og:url" content="http://tmg-drama.herokuapp.com/<%= version %>/<%= seed %>">
<meta property="og:description" content="<%= drama %>">
<% else %>
<meta property="og:url" content="http://tmg-drama.herokuapp.com/">
<% end %>
</head>
<body>
<style>
